...
public class ScannedProductScannerActivity extends Activity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        Intent eanIntent = new Intent(this, ScannedProductScannerResultActivity.class);
